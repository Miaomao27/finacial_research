...
# ============ 保存中间数据 ============
df.to_csv(f'{OUTPUT_DIR}/data_daily_with_ganzhi.csv', index=False, encoding='utf-8-sig')
...
# 回归3: 月天干五行 + 阳历月份 + 年份
# Include year dummies for the main years
