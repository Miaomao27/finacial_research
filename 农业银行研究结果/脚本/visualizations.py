...
fig.suptitle('农业银行(601288) 2010-2026 日收益率按五行分组分布', fontsize=15, fontweight='bold', y=1.02)
plt.tight_layout()
...
fig.suptitle('农业银行 五行分组周收益率 3年滚动窗口差异 (156周窗口)', fontsize=14, fontweight='bold')
plt.tight_layout()
...
ax.set_title('农业银行月累计收益 (2010-2026)', fontsize=12)
ax.set_ylabel('累计净值')
ax.legend()
